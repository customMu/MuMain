...
//
// Trimmed to English-only for now: translations for the other locales aren't
// proofread yet, so offering them in the picker would show half-finished
// text. Restore the commented-out entries once real translations are ready -
// nothing else needs to change, the combo box already handles any list size.
